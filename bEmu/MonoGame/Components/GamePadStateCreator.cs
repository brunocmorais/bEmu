...
using GamePadState = bEmu.Core.Input.GamePadState;

namespace bEmu.Components
{
    public static class GamePadStateCreator
    {
        public static GamePadState Create(Keys[] pressedKeys)
        {
