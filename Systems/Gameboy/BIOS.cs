...
namespace bEmu.Systems.Gameboy
{
    public class BIOS
    {
        ...
        public BIOS(ISystem system, bool isGBC)
        {
            running = true;
            IsGBC = isGBC;
            System = system;
        ...
        public byte this[int index] => IsGBC ? gbcBios[index] : gbBios[index];
    }
}