...
namespace bEmu.Systems.Chip8
{
    public class State : Core.State
    {
        ...
        public override byte[] SaveState()
        {
            ...
            var keys = BitUtils.ToBytes(GamePad.Keys).ToList();
        ...
        public override void LoadState(byte[] value)
        {
            ...
            GamePad.Keys = BitUtils.FromBytes<bool>(bytes.GetRange((counter += size = (sizeof(bool) * GamePad.Keys.Length)) - size, size), GamePad.Keys.Length);
